...
readonly LOCAL_DOMAIN=learningapp.online.test:8081
readonly SSH_HOST=deploy@stage.learningapp.online
...
ssh $SSH_HOST "export PGUSER=postgres && pg_dump learningapp --no-owner > /tmp/db-dump.sql"
